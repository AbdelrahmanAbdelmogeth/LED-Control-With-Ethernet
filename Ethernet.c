...
board.
The project uses the Web Browser method to establish Ethernet based communicaÅon between
...
//
// Ethernet NIC interface definiÅons
//
...
//
// Define Serial Ethernet Board MAC Address, and IP address to be used for the communicaÅon
//
...
void main()
{
  ...
  PORTD = 0;
  SPI1_Init(); // IniÅalize SPI module
